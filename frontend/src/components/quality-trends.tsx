...
function LiveTrends({ days, project }: { days: string; project: string }) {
  ...
  return <div className="space-y-4">
    ...
    {data && current && <>
      ...
      {current.queries === 0 && !data.limited && <p className="rounded-lg bg-muted/20 p-3 text-xs leading-5 text-muted-foreground">No recorded queries in these {days} complete days. Today’s activity appears tomorrow.</p>}
