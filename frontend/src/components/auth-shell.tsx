 ...
 * small eyebrow badge, a bold heading and a muted subtitle. The Login/Sign Up
...
export function AuthShell({
  ...
  return (
    ...
    >
      <Card className="w-full max-w-md max-h-[calc(100svh-2rem)] overflow-y-auto rounded-none py-5 no-scrollbar sm:py-8">
        <CardContent className="flex flex-col gap-4 sm:gap-6">
          <div className="flex flex-col items-center gap-2 text-center">
            <BrandMark
              className="size-11 shrink-0 rounded-none sm:size-12"
              imgClassName="scale-150"
            />
            <span className="rounded-none border bg-muted/60 px-3 py-1 text-[11px] font-medium text-muted-foreground">
              {badge}
            </span>
