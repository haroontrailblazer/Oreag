...
const fixture: AccountUsage = {
  ...
  by_api_key: [
    ...
    {
      api_key_id: "research",
      key_prefix: "oreag_live_f527",
      revoked: false,
      requests: 94,
      prompt_tokens: 164_000,
      completion_tokens: 28_000,
      cost_usd: 3.26,
    },
    {
      api_key_id: "staging",
      key_prefix: "oreag_test_4d12",
      revoked: false,
      requests: 52,
  ...
  by_project: [
    ...
    },
    {
      ...
      requests: 184,
      cost_usd: 7.46,
      cache: { l1: 48, l2: 42, miss: 94, hit_rate: 0.489 },
      avg_retrieval_similarity: 0.81,
      avg_cache_similarity: 0.93,
      saved_prompt_tokens: 118_000,
      saved_completion_tokens: 22_000,
    },
    {
      project_id: "sandbox",
      ...
      requests: 96,
      cost_usd: 3.18,
      cache: { l1: 18, l2: 16, miss: 62, hit_rate: 0.354 },
      avg_retrieval_similarity: 0.69,
      avg_cache_similarity: 0.84,
      saved_prompt_tokens: 54_000,
      saved_completion_tokens: 9_000,
    },
  ],
